...
private:
	std::string getConnectionString() {
		...
		// Default example for local SQL Server/Express. Adjust as needed.
		return std::string("Driver={ODBC Driver 18 for SQL Server};Server=localhost;Database=MyTetris;UID=sa;PWD=YourStrong!Passw0rd;Encrypt=No;TrustServerCertificate=Yes;");
	}
